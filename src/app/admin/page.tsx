        ...
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="flex items-center gap-2 text-sm text-green-700 border border-green-200 bg-green-50 px-4 py-2 rounded-lg hover:bg-green-100 transition font-bold"
            >
              <TrendingUp size={16} /> Advanced Analytics
            </Link>
            <button
              onClick={fetchLeads}
              className="text-sm text-gray-700 border border-gray-200 bg-gray-50 px-4 py-2 rounded-lg hover:bg-gray-100 transition font-medium"
            >
              ↻ Refresh
            </button>
          </div>
