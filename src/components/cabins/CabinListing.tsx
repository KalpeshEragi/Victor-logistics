...
import { Cabin, formatPrice, getRouteBase } from "@/data/cabins";

interface CabinListingProps {
  cabins: Cabin[];
  /** Display label shown in headings, e.g. "Prefab" or "Fabricated" */
  typeLabel: string;
...
export default function CabinListing({
  cabins,
  typeLabel,
  heroDescription,
  heroImage,
}: CabinListingProps) {
  const routeBase = cabins[0] ? getRouteBase(cabins[0].builtType) : "#";
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 leading-tight">
                <span className="text-green-700">{typeLabel} Cabins</span> &{" "}
                Structures
              </h1>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="text-center mb-14">
            ...
            <p className="mt-3 text-gray-600">
              {typeLabel} solutions for every need
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#eef7ec] to-white rounded-2xl p-6 border border-green-100 text-center">
              ...
              <p className="text-gray-600 text-sm">
                {typeLabel} site offices and workspaces from 10ft to 40ft
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#f5faf2] to-white rounded-2xl p-6 border border-green-100 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Guard rooms and security posts in various sizes
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#eef7ec] to-white rounded-2xl p-6 border border-green-100 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Portable sanitation solutions for sites and events
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="products" className="bg-[#f8faf8]">
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800">
              {typeLabel} Cabins For Sale
            </h2>
            <p className="mt-3 text-gray-600">
              Swipe or click to explore our available inventory
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-gradient-to-br from-[#f8faf8] to-white rounded-xl p-6 border border-gray-100 text-center hover:shadow-md transition-shadow"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-5">
                Need a {typeLabel} Cabin?
              </h2>
              <ul className="space-y-3 text-gray-600 text-base">
                <li className="flex items-center gap-3">
                  <span className="text-green-600">✓</span> Office, Security &
                  Toilet Cabins
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-green-600">✓</span> Custom sizes
                  available
                </li>
                <li className="flex items-center gap-3">
